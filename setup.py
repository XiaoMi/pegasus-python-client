...
setup(
    ...
    install_requires=['twisted==17.9.0', 'aenum==2.0.9', 'thrift==0.9.3', 'pyopenssl==17.5.0','incremental==21.3.0','Automat==0.3.0','constantly==15.1','hyperlink==17.1.1','zope.interface==3.6.0'],
