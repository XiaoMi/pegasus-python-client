...
class update_request:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'key', (ttypes.blob, ttypes.blob.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'value', (ttypes.blob, ttypes.blob.thrift_spec), None, ), # 2
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.key = ttypes.blob()
          self.key.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRUCT:
          self.value = ttypes.blob()
...
class multi_put_request:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'hash_key', (ttypes.blob, ttypes.blob.thrift_spec), None, ), # 1
...
class multi_remove_request:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'hash_key', (ttypes.blob, ttypes.blob.thrift_spec), None, ), # 1
    (2, TType.LIST, 'sork_keys', (TType.STRUCT,(ttypes.blob, ttypes.blob.thrift_spec)), None, ), # 2
...
class get_scanner_request:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'start_key', (ttypes.blob, ttypes.blob.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'stop_key', (ttypes.blob, ttypes.blob.thrift_spec), None, ), # 2
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.start_key = ttypes.blob()
          self.start_key.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRUCT:
          self.stop_key = ttypes.blob()
