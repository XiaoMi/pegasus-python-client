...
class multi_put_request(object):
    """
    Attributes:
     - hash_key
     - kvs
...
class multi_remove_request(object):
    """
    Attributes:
     - hash_key
     - sork_keys
...
class multi_remove_response(object):
    """
    Attributes:
     - error
     - count
...
class multi_get_request(object):
    """
    Attributes:
     - hash_key
     - sork_keys
...
class multi_get_response(object):
    """
    Attributes:
     - error
     - kvs
...
class check_and_set_request(object):
    """
    Attributes:
     - hash_key
     - check_sort_key
...
class check_and_set_response(object):
    """
    Attributes:
     - error
...
class check_and_mutate_request(object):
    """
    Attributes:
     - hash_key
     - check_sort_key
...
class check_and_mutate_response(object):
    """
    Attributes:
     - error
     - check_value_returned
...
class get_scanner_request(object):
    """
    Attributes:
     - start_key
     - stop_key
...
class scan_response(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(update_request)
update_request.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
    (2, TType.STRUCT, 'value', [pypegasus.base.ttypes.blob, None], None, ),  # 2
    (3, TType.I32, 'expire_ts_seconds', None, None, ),  # 3
)
all_structs.append(update_response)
update_response.thrift_spec = (
    None,  # 0
    ...
    (5, TType.STRING, 'server', 'UTF8', None, ),  # 5
)
all_structs.append(read_response)
read_response.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'error', None, None, ),  # 1
    (2, TType.STRUCT, 'value', [pypegasus.base.ttypes.blob, None], None, ),  # 2
    ...
    None,  # 5
    (6, TType.STRING, 'server', 'UTF8', None, ),  # 6
)
all_structs.append(ttl_response)
ttl_response.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'error', None, None, ),  # 1
...
all_structs.append(count_response)
count_response.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'error', None, None, ),  # 1
...
all_structs.append(key_value)
key_value.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
    (2, TType.STRUCT, 'value', [pypegasus.base.ttypes.blob, None], None, ),  # 2
)
all_structs.append(multi_put_request)
multi_put_request.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'hash_key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
    (2, TType.LIST, 'kvs', (TType.STRUCT, [key_value, None], False), None, ),  # 2
    (3, TType.I32, 'expire_ts_seconds', None, None, ),  # 3
)
all_structs.append(multi_remove_request)
multi_remove_request.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'hash_key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
    (2, TType.LIST, 'sork_keys', (TType.STRUCT, [pypegasus.base.ttypes.blob, None], False), None, ),  # 2
    (3, TType.I64, 'max_count', None, None, ),  # 3
)
all_structs.append(multi_remove_response)
multi_remove_response.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'error', None, None, ),  # 1
    (2, TType.I64, 'count', None, None, ),  # 2
    (3, TType.I32, 'app_id', None, None, ),  # 3
...
all_structs.append(multi_get_request)
multi_get_request.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'hash_key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
    (2, TType.LIST, 'sork_keys', (TType.STRUCT, [pypegasus.base.ttypes.blob, None], False), None, ),  # 2
    ...
    (6, TType.STRUCT, 'start_sortkey', [pypegasus.base.ttypes.blob, None], None, ),  # 6
    (7, TType.STRUCT, 'stop_sortkey', [pypegasus.base.ttypes.blob, None], None, ),  # 7
    ...
    (11, TType.STRUCT, 'sort_key_filter_pattern', [pypegasus.base.ttypes.blob, None], None, ),  # 11
    (12, TType.BOOL, 'reverse', None, None, ),  # 12
)
all_structs.append(multi_get_response)
multi_get_response.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'error', None, None, ),  # 1
    (2, TType.LIST, 'kvs', (TType.STRUCT, [key_value, None], False), None, ),  # 2
    (3, TType.I32, 'app_id', None, None, ),  # 3
...
all_structs.append(incr_request)
incr_request.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
    (2, TType.I64, 'increment', None, None, ),  # 2
    (3, TType.I32, 'expire_ts_seconds', None, None, ),  # 3
)
all_structs.append(incr_response)
incr_response.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'error', None, None, ),  # 1
...
all_structs.append(check_and_set_request)
check_and_set_request.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'hash_key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
    (2, TType.STRUCT, 'check_sort_key', [pypegasus.base.ttypes.blob, None], None, ),  # 2
    (3, TType.I32, 'check_type', None, None, ),  # 3
    (4, TType.STRUCT, 'check_operand', [pypegasus.base.ttypes.blob, None], None, ),  # 4
    (5, TType.BOOL, 'set_diff_sort_key', None, None, ),  # 5
    (6, TType.STRUCT, 'set_sort_key', [pypegasus.base.ttypes.blob, None], None, ),  # 6
    (7, TType.STRUCT, 'set_value', [pypegasus.base.ttypes.blob, None], None, ),  # 7
    (8, TType.I32, 'set_expire_ts_seconds', None, None, ),  # 8
    (9, TType.BOOL, 'return_check_value', None, None, ),  # 9
)
all_structs.append(check_and_set_response)
check_and_set_response.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'error', None, None, ),  # 1
    (2, TType.BOOL, 'check_value_returned', None, None, ),  # 2
    (3, TType.BOOL, 'check_value_exist', None, None, ),  # 3
    (4, TType.STRUCT, 'check_value', [pypegasus.base.ttypes.blob, None], None, ),  # 4
    (5, TType.I32, 'app_id', None, None, ),  # 5
    (6, TType.I32, 'partition_index', None, None, ),  # 6
    (7, TType.I64, 'decree', None, None, ),  # 7
    (8, TType.STRING, 'server', 'UTF8', None, ),  # 8
)
all_structs.append(mutate)
mutate.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'operation', None, None, ),  # 1
    (2, TType.STRUCT, 'sort_key', [pypegasus.base.ttypes.blob, None], None, ),  # 2
    (3, TType.STRUCT, 'value', [pypegasus.base.ttypes.blob, None], None, ),  # 3
    (4, TType.I32, 'set_expire_ts_seconds', None, None, ),  # 4
)
all_structs.append(check_and_mutate_request)
check_and_mutate_request.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'hash_key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
    (2, TType.STRUCT, 'check_sort_key', [pypegasus.base.ttypes.blob, None], None, ),  # 2
    (3, TType.I32, 'check_type', None, None, ),  # 3
    (4, TType.STRUCT, 'check_operand', [pypegasus.base.ttypes.blob, None], None, ),  # 4
    (5, TType.LIST, 'mutate_list', (TType.STRUCT, [mutate, None], False), None, ),  # 5
    (6, TType.BOOL, 'return_check_value', None, None, ),  # 6
)
all_structs.append(check_and_mutate_response)
check_and_mutate_response.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'error', None, None, ),  # 1
    (2, TType.BOOL, 'check_value_returned', None, None, ),  # 2
    (3, TType.BOOL, 'check_value_exist', None, None, ),  # 3
...
all_structs.append(get_scanner_request)
get_scanner_request.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'start_key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
    (2, TType.STRUCT, 'stop_key', [pypegasus.base.ttypes.blob, None], None, ),  # 2
    ...
    (8, TType.STRUCT, 'hash_key_filter_pattern', [pypegasus.base.ttypes.blob, None], None, ),  # 8
    (9, TType.I32, 'sort_key_filter_type', None, None, ),  # 9
    (10, TType.STRUCT, 'sort_key_filter_pattern', [pypegasus.base.ttypes.blob, None], None, ),  # 10
    (11, TType.BOOL, 'need_check_hash', None, None, ),  # 11
)
all_structs.append(scan_request)
scan_request.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'context_id', None, None, ),  # 1
)
all_structs.append(scan_response)
scan_response.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'error', None, None, ),  # 1
    (2, TType.LIST, 'kvs', (TType.STRUCT, [key_value, None], False), None, ),  # 2
