...
class Iface(object):
    ...
    def check_and_set(self, request):
        """
        Parameters:
         - request
        """
    ...
    def check_and_mutate(self, request):
        """
        Parameters:
         - request
        """
...
class Client(Iface):
    ...
    def incr(self, request):
        ...
        Parameters:
         - request
        """
        self.send_incr(request)
        return self.recv_incr()

    def send_incr(self, request):
        self._oprot.writeMessageBegin('incr', TMessageType.CALL, self._seqid)
        args = incr_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_incr(self):
        ...
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "incr failed: unknown result")
    ...
    def check_and_set(self, request):
        ...
        Parameters:
         - request
        """
        self.send_check_and_set(request)
        return self.recv_check_and_set()

    def send_check_and_set(self, request):
        self._oprot.writeMessageBegin('check_and_set', TMessageType.CALL, self._seqid)
        args = check_and_set_args()
        args.request = request
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_check_and_set(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = check_and_set_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "check_and_set failed: unknown result")
    ...
    def check_and_mutate(self, request):
        ...
        Parameters:
         - request
        """
        self.send_check_and_mutate(request)
        return self.recv_check_and_mutate()

    def send_check_and_mutate(self, request):
        self._oprot.writeMessageBegin('check_and_mutate', TMessageType.CALL, self._seqid)
    ...
    def recv_check_and_mutate(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = check_and_mutate_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "check_and_mutate failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["incr"] = Processor.process_incr
        self._processMap["check_and_set"] = Processor.process_check_and_set
        self._processMap["check_and_mutate"] = Processor.process_check_and_mutate
    ...
    def process_incr(self, seqid, iprot, oprot):
        args = incr_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = incr_result()
        try:
            result.success = self._handler.incr(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("incr", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_check_and_set(self, seqid, iprot, oprot):
        args = check_and_set_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = check_and_set_result()
        try:
            result.success = self._handler.check_and_set(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("check_and_set", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_check_and_mutate(self, seqid, iprot, oprot):
        args = check_and_mutate_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = check_and_mutate_result()
        try:
            result.success = self._handler.check_and_mutate(args.request)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("check_and_mutate", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
put_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'update', [update_request, None], None, ),  # 1
)
...
put_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [update_response, None], None, ),  # 0
)


class multi_put_args(object):
    """
    Attributes:
     - request
    """
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multi_put_args)
multi_put_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [multi_put_request, None], None, ),  # 1
)


class multi_put_result(object):
    """
    Attributes:
     - success
    """
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multi_put_result)
multi_put_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [update_response, None], None, ),  # 0
)
...
remove_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
)
...
class multi_remove_args(object):
    """
    Attributes:
     - request
    """
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multi_remove_args)
multi_remove_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [multi_remove_request, None], None, ),  # 1
)


class multi_remove_result(object):
    """
    Attributes:
     - success
    """
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multi_remove_result)
multi_remove_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [multi_remove_response, None], None, ),  # 0
)


class incr_args(object):
    """
    Attributes:
     - request
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('incr_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(incr_args)
incr_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [incr_request, None], None, ),  # 1
)


class incr_result(object):
    """
    Attributes:
     - success
    """
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('incr_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(incr_result)
incr_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [incr_response, None], None, ),  # 0
)


class check_and_set_args(object):
    """
    Attributes:
     - request
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.request = check_and_set_request()
                    self.request.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('check_and_set_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(check_and_set_args)
check_and_set_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [check_and_set_request, None], None, ),  # 1
)


class check_and_set_result(object):
    """
    Attributes:
     - success
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = check_and_set_response()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('check_and_set_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(check_and_set_result)
check_and_set_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [check_and_set_response, None], None, ),  # 0
)


class check_and_mutate_args(object):
    """
    Attributes:
     - request
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.request = check_and_mutate_request()
                    self.request.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('check_and_mutate_args')
        if self.request is not None:
            oprot.writeFieldBegin('request', TType.STRUCT, 1)
            self.request.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(check_and_mutate_args)
check_and_mutate_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [check_and_mutate_request, None], None, ),  # 1
)


class check_and_mutate_result(object):
    """
    Attributes:
     - success
    """
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = check_and_mutate_response()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('check_and_mutate_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(check_and_mutate_result)
check_and_mutate_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [check_and_mutate_response, None], None, ),  # 0
)
...
get_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [read_response, None], None, ),  # 0
)


class multi_get_args(object):
    """
    Attributes:
     - request
    """
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multi_get_args)
multi_get_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [multi_get_request, None], None, ),  # 1
)


class multi_get_result(object):
    """
    Attributes:
     - success
    """
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(multi_get_result)
multi_get_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [multi_get_response, None], None, ),  # 0
)


class sortkey_count_args(object):
    """
    Attributes:
     - hash_key
    """
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(sortkey_count_args)
sortkey_count_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'hash_key', [pypegasus.base.ttypes.blob, None], None, ),  # 1
)


class sortkey_count_result(object):
    """
    Attributes:
     - success
    """
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(sortkey_count_result)
sortkey_count_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [count_response, None], None, ),  # 0
)
...
ttl_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [ttl_response, None], None, ),  # 0
)


class get_scanner_args(object):
    """
    Attributes:
     - request
    """
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_scanner_args)
get_scanner_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [get_scanner_request, None], None, ),  # 1
)


class get_scanner_result(object):
    """
    Attributes:
     - success
    """
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_scanner_result)
get_scanner_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [scan_response, None], None, ),  # 0
)
...
scan_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'request', [scan_request, None], None, ),  # 1
)
...
class clear_scanner_args(object):
    """
    Attributes:
     - context_id
    """
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(clear_scanner_args)
clear_scanner_args.thrift_spec = (
    None,  # 0
