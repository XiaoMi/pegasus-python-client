...
class partition_configuration:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'pid', (ttypes.gpid, ttypes.gpid.thrift_spec), None, ), # 1
    (2, TType.I64, 'ballot', None, None, ), # 2
    (3, TType.I32, 'max_replica_count', None, None, ), # 3
    (4, TType.STRUCT, 'primary', (ttypes.rpc_address, ttypes.rpc_address.thrift_spec), None, ), # 4
    (5, TType.LIST, 'secondaries', (TType.STRUCT,(ttypes.rpc_address, ttypes.rpc_address.thrift_spec)), None, ), # 5
    (6, TType.LIST, 'last_drops', (TType.STRUCT,(ttypes.rpc_address, ttypes.rpc_address.thrift_spec)), None, ), # 6
...
class query_cfg_response:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'err', (ttypes.error_code, ttypes.error_code.thrift_spec), None, ), # 1
